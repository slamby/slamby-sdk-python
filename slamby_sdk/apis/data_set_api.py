...
class DataSetApi(object):
    ...
    def create_data_set(self, **kwargs):
        ...
        >>> thread = api.create_data_set(callback=callback_function)
        ...
        resource_path = '/api/DataSets'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_data_set(self, name, **kwargs):
        ...
        >>> thread = api.delete_data_set(name, callback=callback_function)
        ...
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `delete_data_set`")



        resource_path = '/api/DataSets/{name}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_data_set(self, name, **kwargs):
        """
        ...
        >>> thread = api.get_data_set(name, callback=callback_function)
        ...
        # verify the required parameter 'name' is set
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_data_set`")
    ...
    def get_data_sets(self, **kwargs):
        ...
        >>> thread = api.get_data_sets(callback=callback_function)
