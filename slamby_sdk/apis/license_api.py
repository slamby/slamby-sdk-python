...
class LicenseApi(object):
    ...
    def change_license(self, **kwargs):
        """
        ...
        >>> thread = api.change_license(callback=callback_function)
        ...
        resource_path = '/api/License'.replace('{format}', 'json')
        path_params = {}
